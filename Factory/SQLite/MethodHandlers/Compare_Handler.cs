...
namespace SZORM.SQLite.MethodHandlers
{
    class Compare_Handler : IMethodHandler
    {
        ...
        {
            return exp.Method.DeclaringType == Factory.SQLite.UtilConstants.TypeOfSql;
        }
        public void Process(DbMethodCallExpression exp, SqlGenerator generator)
        {
            ...
            switch (compareType)
            {
                case CompareType.eq:
                    {
                        MethodInfo method_Sql_Equals = Factory.SQLite.UtilConstants.MethodInfo_Sql_Equals.MakeGenericMethod(left.Type);
                ...
                case CompareType.neq:
                    {
                        MethodInfo method_Sql_NotEquals = Factory.SQLite.UtilConstants.MethodInfo_Sql_NotEquals.MakeGenericMethod(left.Type);
