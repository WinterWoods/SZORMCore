...
namespace SZORM.Oracle.MethodHandlers
{
    class Contains_Handler : IMethodHandler
    {
        public bool CanProcess(DbMethodCallExpression exp)
        {
            ...
            if (exp.Method == Factory.Oracle.UtilConstants.MethodInfo_String_Contains)
            {
                return true;
            }
        ...
        static void In(SqlGenerator generator, List<DbExpression> elementExps, DbExpression operand)
        {
            ...
            List<List<DbExpression>> batches = Utils.InBatches(elementExps, Factory.Oracle.UtilConstants.InElements);
