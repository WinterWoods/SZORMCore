...
{
    public class SZORMOracleConnection : IDbConnection, IDisposable, ICloneable
    {
        IDbConnection _dbConnection;
        public SZORMOracleConnection(IDbConnection dbConnection)
        {
        ...
        public object Clone()
        {
            ...
            {
                return new SZORMOracleConnection((IDbConnection)((ICloneable)this._dbConnection).Clone());
            }
